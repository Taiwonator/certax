    ...
    render() {
        return (
            <div className='home-container' style={{backgroundColor: this.darkMode()}}>
                ...
                <GetAQuoteSection ref={this.getaquoteRef} scrollToQuote={this.scrollToGetAQuote} scrollToQuoteQuestions={this.scrollToQuoteQuestions} darkMode={this.darkMode} colors={this.props.colors} data={this.props.getaquote} connectToWebSocket={this.props.connectToWebSocket}/>
